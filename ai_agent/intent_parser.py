...
Examples:
- "Find CTOs at AI companies in San Francisco" → titles: [CTO], industries: [AI], locations: [San Francisco]
- "Get investors in the FinTech space" → tags: [investor], industries: [FinTech]
- "Partnership outreach to SaaS CEOs" → titles: [CEO], industries: [SaaS], campaign_objective: partnership
"""
